...
echo "=== 4/6 Зрение (pvo_vision.py) ==="
python3 test_vision.py | tail -3

echo "=== 5/6 Логика GUI (pvo_gui.py) ==="
python3 test_gui_logic.py | tail -3

echo "=== 6/6 Слияние радара и зрения (pvo_fusion.py) ==="
